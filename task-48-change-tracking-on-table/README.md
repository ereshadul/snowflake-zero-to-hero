# Task 48 — CHANGE_TRACKING & the CHANGES() clause
...
## Steps
1. Run `49_change_tracking_on_table.sql`.
2. Work through it section by section against your own Snowflake trial
   — don't just read it.
3. Answer the understanding check below before moving to the next task.

## Understanding check
See the bottom of `49_change_tracking_on_table.sql`. Answer by actually running the
