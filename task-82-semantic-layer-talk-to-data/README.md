...
turns the star schema from Task 77 into something a non-SQL user can
query in plain English.

## Steps
1. Run `83_semantic_layer_talk_to_data.sql`.
2. Work through it section by section against your own Snowflake trial
   — don't just read it.
3. Answer the understanding check below before moving to the next task.

## Understanding check
See the bottom of `83_semantic_layer_talk_to_data.sql`. Answer by
