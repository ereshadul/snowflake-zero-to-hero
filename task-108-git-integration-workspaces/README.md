...
than the GitHub Actions/external-CI approach in Task 107.

## Steps
1. Run `109_git_integration_workspaces.sql`.
2. Work through it section by section against your own Snowflake trial
   — don't just read it.
3. Answer the understanding check below before moving to the next task.

## Understanding check
See the bottom of `109_git_integration_workspaces.sql`. Answer by
