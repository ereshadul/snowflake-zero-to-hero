# Task 36 — Consuming/emptying a stream
...
## Steps
1. Run `37_stream_consuming_emptying.sql`.
2. Work through it section by section against your own Snowflake trial
   — don't just read it.
3. Answer the understanding check below before moving to the next task.

## Understanding check
See the bottom of `37_stream_consuming_emptying.sql`. Answer by actually running the
