# Task 38 — No-schedule/triggered tasks
...
## Steps
1. Run `39_task_no_schedule_triggered.sql`.
2. Work through it section by section against your own Snowflake trial
   — don't just read it.
3. Answer the understanding check below before moving to the next task.

## Understanding check
See the bottom of `39_task_no_schedule_triggered.sql`. Answer by actually running the
