# Task 7 — PERMANENT vs. TRANSIENT vs. TEMPORARY tables
...
## Steps
1. Run `08_transient_temporary_permanent_tables.sql`.
2. Work through it section by section against your own Snowflake trial
   — don't just read it.
3. Answer the understanding check below before moving to the next task.

## Understanding check
See the bottom of `08_transient_temporary_permanent_tables.sql`. Answer by actually running the
