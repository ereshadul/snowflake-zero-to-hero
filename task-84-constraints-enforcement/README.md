# Task 84 — What constraints Snowflake actually enforces
...
## Steps
1. Run `85_constraints_enforcement.sql`.
2. Work through it section by section against your own Snowflake trial
   — don't just read it.
3. Answer the understanding check below before moving to the next task.

## Understanding check
See the bottom of `85_constraints_enforcement.sql`. Answer by actually running the
