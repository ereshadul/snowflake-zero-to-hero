# Task 47 — Change-tracking columns (METADATA$...)
...
## Steps
1. Run `48_change_tracking_columns.sql`.
2. Work through it section by section against your own Snowflake trial
   — don't just read it.
3. Answer the understanding check below before moving to the next task.

## Understanding check
See the bottom of `48_change_tracking_columns.sql`. Answer by actually running the
