# Task 47 — Retention & storage cost
...
## Steps
1. Run `48_time_travel_retention_cost.sql`.
2. Work through it section by section against your own Snowflake trial
   — don't just read it.
3. Answer the understanding check below before moving to the next task.

## Understanding check
See the bottom of `48_time_travel_retention_cost.sql`. Answer by actually running the
